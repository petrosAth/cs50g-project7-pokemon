            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        -- create a table to save pokemon stats before level up
                        local currentStats = {
                            HP = self.battleState.playerPokemon.HP, atk = self.battleState.playerPokemon.attack, def = self.battleState.playerPokemon.defense, spd = self.battleState.playerPokemon.speed
                        }
                        -- create a table to catch stats increases from level up
                        local levelUpStats = {
                            'HPInc', 'atkInc', 'defInc', 'spdInc'
                        }
                        levelUpStats.HPInc, levelUpStats.atkInc, levelUpStats.defInc, levelUpStats.spdInc = self.playerPokemon:levelUp()
                        ...
                        Timer.after(1.5, function()
                            ...
                            gStateStack:push(LevelUpMenuState(currentStats, levelUpStats))
                        end)
